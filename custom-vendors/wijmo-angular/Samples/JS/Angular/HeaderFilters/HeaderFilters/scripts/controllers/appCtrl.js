...
app.controller('appCtrl', function appCtrl($scope) {
    ...
    cmbTitle.textChanged.addHandler(function () {
        updateFilter('title', cmbTitle.text);
    });
    stopPropagation(cmbTitle.hostElement);
    ...
    cmbAuth.textChanged.addHandler(function () {
        updateFilter('author', cmbAuth.text);
    });
    stopPropagation(cmbAuth.hostElement);
    ...
    inPrice.valueChanged.addHandler(function () {
        updateFilter('price', inPrice.value);
    });
