angular.module('ctApp.payClasses', ['ui.router']).config([
  '$stateProvider',
  ...
  function ($scope, Services, $state, $modal, $localStorage) {
    ...
    $scope.enableEditView = function (id) {
      $state.go('ctApp.addUpdatePayClass', { payClassId: id });
    };
    $scope.enableDelete = function (id) {
      ...
      $scope.modalInstance.result.then(function (id) {
        Services.agencyPayclass.delete({ filter: 'id=\'' + id + '\'' }, function (data) {
          //agency_pay_class
          $scope.logger = {};
          ...
          $scope.logger.action_table = 'agency_pay_class';
  ...
  function ($scope, Services, $state, $stateParams, $timeout, HelperService, $localStorage) {
    ...
    $scope.getPayClassDetail = function () {
      if ($scope.payClass_id) {
        ...
        Services.agencyPayclass.get({ 'filter': 'id=\'' + $scope.payClass_id + '\'' }, function (resp) {
