PortingFromSL
------------------------------------------------------------------------
Shows how you can build scheduling applications using our Calendar control and Firebase. The application supports multiple users in real time, and includes user authentication.
