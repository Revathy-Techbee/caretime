...
angular.module('utils.ct.directives', ['ui.load'])
    ...
    .directive('locationForm', ['$rootScope', 'Services', '$timeout', function($rootScope, Services, $timeout){
        return{
            restrict: 'E',
            controller: function($scope){
                ...
                function fillInAddress() {
                    ...
                    // $scope.address1 = street_number+" "+street;
                    // $scope.zip      = zip;
                    // $scope.city     = city;
                    // $scope.state    = state;
            ...
            //template: '<div class="wrapper-md"><form name="location" class="form-validation form-horizontal location" ng-submit="locationManage()" novalidate><div class="form-group"><label class="col-sm-2 control-label">Enter Your Address </label><div class="col-sm-10"><input type="text" ng-focus="geolocate()" class="form-control" placeholder="Enter Your Address"></div></div><div class="form-group"><label class="col-sm-2 control-label">Address Line</label><div class="col-sm-10"><input type="text"  class="form-control" placeholder="Enter Address line" required="" ng-model="address1" > </div> <div class="line"></div><label class="col-sm-2 control-label">Address Line 2</label> <div class="col-sm-10"> <input type="text"  class="form-control" placeholder="Address line 2 (optional)" ng-model="address2" >  </div>  <div class="line"></div><label class="col-sm-2 control-label">Zip/County/City/State *</label>  <div class="col-sm-10"> <div class="row">  <div class="col-md-3"><input type="text" class="form-control" ng-required="true" ng-maxlength="5" placeholder="ZIP" ng-model="zip" ng-pattern="/^[0-9]+$/"></div> <div class="col-md-3"> <input type="text" class="form-control" required="" placeholder="County" ng-model="county" > </div><div class="col-md-4">  <input type="text" class="form-control" required="" placeholder="City" ng-model="city" >  </div> <div class="col-md-2"> <input type="text" class="form-control" required="" placeholder="State" ng-model="state" > </div> </div><div class="row" ng-show="showZipError"><div class="line"></div><div class="col-sm-12"><div role="alert" class="alert ng-isolate-scope alert-warning alert-dismissable"  type="warning" > <div ><span class="ng-binding ng-scope">No match found, but continue adding the data</span></div></div> </div> </div></form></div>'
    ...
    .directive('multiField', ['$document', function($document) {
    ...
    .controller("newUploaderCtl", ["$scope","$rootScope", "Services", "$state", "HelperService", "$modal","$timeout","$element","$attrs",
