   ...
   // 'ctApp.alertReport',
    ...
    .config(['$stateProvider', '$urlRouterProvider', function config($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider.state('ctApp', {
            ...
            data: { pageTitle: 'Application', access: access.public }
        });
    ...
    .controller("headerController", ["$scope", "Auth","Services", function($scope, Auth,Services){
    ...
    .controller("NavCtrl", ["$scope", "Auth","Services", function($scope, Auth,Services){
        $scope.user = Auth.user;
        $scope.userRoles = Auth.userRoles;
        $scope.accessLevels = Auth.accessLevels;
