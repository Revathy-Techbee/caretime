...
.controller("AlertLogCtrl", ["$scope", "Services", "HelperService", "$timeout","$localStorage", function($scope, Services, HelperService, $timeout,$localStorage) {
    $scope.logFilters = {};
    ...
    if($localStorage.user_info.iszone_code){
           ...
           $scope.logFilters.zone=[{"text": res.data.record[0]["zone_name"],
    ...
    $scope.logFilters.alertType ={text: 'All', id: 'all'};
