...
.controller("EmployeeWeeklyHoursCtrl", ["$scope", "Services", "HelperService", "$timeout","$localStorage",
    function($scope, Services, HelperService, $timeout,$localStorage) {
        ...
        $scope.getweekdate = function() {
           ...
           /* if ($scope.noofdays === 0) {
            ...
            $scope.week_days = $scope.week_startNo - $scope.noofdays-1; //to calculate end date
                if($scope.noofdays=='0')
                {
