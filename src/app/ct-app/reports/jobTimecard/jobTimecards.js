...
.controller("JobTimecardCtrl", ["$scope", "Services", "HelperService", "$timeout","$localStorage",
       ...
       // $scope.reportFilters.zoneName = '';
        ...
        $scope.downloadpdf = function() {
            ...
            angular.forEach($scope.resultData, function(value, key) {
                ...
                var time_float = value.work_duration_non_rounded_number.toString(); //HelperService.timeToFloat(item.work_duration);

                if (value.work_duration_rounded) {
                    roundtime_float = value.work_duration_rounded.toString(); //HelperService.timeToFloat(item.work_duration_rounded);
