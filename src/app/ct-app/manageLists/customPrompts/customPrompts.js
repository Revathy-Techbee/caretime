angular.module('ctApp.customPrompts', [
        'ui.router'
    ])
        ...
        function($scope, Services, $state, $modal,$localStorage) {
            ...
            $scope.getNextData = function(offset) { // on pagination
                ...
                $scope.filterObj = {
                    ...
                    include_count: true,
                    offset: $scope.customPromptDetailList.length, //30
            ...
            $scope.enableEditView = function(id) {
                $state.go("ctApp.addUpdateCustomPrompt", {
                    customPromptId: id
                });
            };
            $scope.enableDelete = function(id) {
                ...
                $scope.modalInstance.result.then(function(id) {
                    ...
                    Services.customPromptService.delete({
                        filter: "id='" + id + "'"
                    }, function(data) {
...
/*
 * Add Update
 * CustomPrompt Controller....
 * **/

.controller("AddUpdateCustomPromptCtrl", ["$scope", "Services", "$state", "$stateParams", "$timeout", "HelperService", "$localStorage",
        function($scope, Services, $state, $stateParams, $timeout, HelperService, $localStorage) {
            ...
            $scope.getCustomPromptDetail = function() {
                if ($scope.customPrompt_id) {
                    ...
                    Services.customPromptService.get({
                        "filter": "id='" + $scope.customPrompt_id + "'"
                    }, function(resp) {
            ...
            $scope.customPromptManage = function(step) {
                ...
                if ($scope.addUpdateCustomPromptForm.$valid) {
                    ...
                    if ($scope.customPrompt_id) { // means it is in edit state
                    ...
                    if ($scope.customPrompt_id) {
                        ...
                        Services.customPromptService.update({
                            id: $stateParams.customPromptId
                        }, $scope.customPromptDBField, function(data) {
                            $scope.show_customPrompt_form_loader = false;
    ...
    .controller("DeleteCustomPromptCtrl", ["$scope", "Services", "$modalInstance", function($scope, Services, $modalInstance) {
