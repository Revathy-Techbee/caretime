...
angular.module('app.Auth', [])
    ...
    .factory('Auth', ['$http', '$cookies', '$cookieStore', '$window', '$localStorage',
        function AuthService($http, $cookies, $cookieStore, $window, $localStorage){

            var accessLevels = routingConfig.accessLevels,
                userRoles = routingConfig.userRoles,
                currentUser = { username: '', role: userRoles.public, full_name : '' };

            //var user_roles = ['employee', 'administrator', 'supervisor', 'consumer'];
          var user_roles = ['Nursing','Admin','HR','OfficeClerical','OfficeMgr','OnCall','CorporateBillingDepartment','Scheduler','Basic',"SuperAdmin"];
            ...
            return {
                ...
                logout: function(success, error) {
                   /* $http.post('api/user/authentication_logout/').success(function(){
                    ...
                    changeUser({ username: '', role: userRoles.public, full_name : '' });
                },
    ...
    .filter('userRoles', [function(){
        return function(role){/// used this filter to only show the data display name...
            //var roles = ["", "Admin", "User", "corporate", "Corporate IT", "Manager", "IT", "Store Account"];
            var roles = ['Nursing','Admin','HR','OfficeClerical','OfficeMgr','OnCall','CorporateBillingDepartment','Scheduler','Basic',"SuperAdmin"];
            return roles[role];
        };
    }])
