angular.module('access.employeeLogin', [
    'ui.router'
        ...
        $scope.employeeLogin = function() {
            ...
            if ($scope.updateuser) {
                ...
                Services.signinService.get({
                    filter: "user_email ='" + $stateParams.empId + "' and user_type='1'"
                }, function(data) {
                    if (data.record.length === 0) {


                        Services.agencyDetail.get({
                            filter: "contact_email ='" + $stateParams.empId + "'"
                        }, function(data) {
                            if (data.record.length > 0) {
                ...
                Services.signinService.get({
                    filter: "user_name='" + $scope.username + "'"
                }, function(data) {
