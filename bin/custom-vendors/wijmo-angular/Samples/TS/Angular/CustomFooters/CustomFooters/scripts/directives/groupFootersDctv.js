...
app.directive('groupFooters', function () {
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            // when rows collection changes, update groups below
            var updating = false;
            flex.rows.collectionChanged.addHandler(function () {
                if (!updating && flex.collectionView.groupDescriptions.length) {
                    updating = true;
                    addGroupFooters();
                    updating = false;
                }
